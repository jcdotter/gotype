...
func createTestVars(b bool, i int, s string, item ...string) map[string]any {
	v := map[string]any{
		...
		"array_ptr_array_single":  [1]*[1]string{{s}},
		"array_ptr_slice_single":  [1]*[]string{{s}},
		"array_ptr_map_single":    [1]*map[string]string{{"0": s}},
		"array_ptr_struct_single": [1]*string_struct_single{{s}},
		"array_ptr_any_single":    [1]any{&s},

		"array_ptr_bool":   [2]*bool{&b, &b},
		"array_ptr_int":    [2]*int{&i, &i},
		"array_ptr_string": [2]*string{&s, &s},
		"array_ptr_array":  [2]*[2]string{{s, s}, {s, s}},
		"array_ptr_slice":  [2]*[]string{{s, s}, {s, s}},
		"array_ptr_map":    [2]*map[string]string{{"0": s, "1": s}, {"0": s, "1": s}},
		"array_ptr_struct": [2]*string_struct{{s, s}, {s, s}},
		...
		"slice_ptr_map_single":    []*map[string]string{{"0": s}},
		...
		"map_ptr_array_single":  map[string]*[1]string{"0": {s}},
		"map_ptr_slice_single":  map[string]*[]string{"0": {s}},
		"map_ptr_map_single":    map[string]*map[string]string{"0": {"0": s}},
		"map_ptr_struct_single": map[string]*string_struct_single{"0": {s}},
		...
		"map_ptr_array":  map[string]*[2]string{"0": {s, s}, "1": {s, s}},
		"map_ptr_slice":  map[string]*[]string{"0": {s, s}, "1": {s, s}},
		"map_ptr_map":    map[string]*map[string]string{"0": {"0": s, "1": s}, "1": {"0": s, "1": s}},
		"map_ptr_struct": map[string]*string_struct{"0": {s, s}, "1": {s, s}},
